//! Build script for the shared deal-ffi crate.
//!
//! Responsibility (moved here from cli/build.rs as part of Plan 03-03 Task 1):
...
//!
//! Path resolution: deal-ffi/ is one level below deal/ (same depth as cli/),
//! so a single `.join("..")` reaches the workspace root.
...
fn main() {
    // deal-ffi/ is one level below deal/.
